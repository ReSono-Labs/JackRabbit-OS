...
final class ManagementRuntimeProxy {
    private static final Set<String> ROUTES = Set.of(
            ...
            "/v1/management/providers/connect",
            "/v1/management/providers/disconnect",
            "/v1/management/providers/provider",
            "/v1/management/providers/models",
            "/v1/management/providers/refresh",
