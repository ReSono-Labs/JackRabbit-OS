...
pub const RELEASE_ID: &str = "jackrabbit-stock-r1-current-v0.1";
...
pub const ARTIFACTS: [Artifact; 12] = [
    ...
    Artifact {
        ...
        size: 1_400_053_760,
        sha256: "2cc98b074b915ffb4346ee0d3226e06d56e2b29c6a3dc98f2571ca0915e85434",
    },
    Artifact {
    ...
    Artifact {
        ...
        size: 369_319_936,
        sha256: "6ea508648edce2e15debddacf2c161a46553c21c6a64de43f90b2eadfae5eba6",
    },
    Artifact {
...
mod tests {
    ...
    fn release_inventory_is_the_exact_current_twelve_file_set() {
        assert_eq!(RELEASE_ID, "jackrabbit-stock-r1-current-v0.1");
        assert_eq!(ARTIFACTS.len(), 12);
        assert_eq!(ARTIFACTS[5].path, "images/jackrabbit/system.img");
        assert_eq!(
            ARTIFACTS[5].sha256,
            "2cc98b074b915ffb4346ee0d3226e06d56e2b29c6a3dc98f2571ca0915e85434"
        );
        assert_eq!(
            ARTIFACTS[2].sha256,
