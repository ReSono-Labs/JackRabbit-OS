...
`install.cmd` opens the prompt-driven Windows installer. A public package
contains the Windows `jackrabbit-installer.exe`, the verified JackRabbit release
directory, Android Platform Tools `fastboot.exe`, and the two reviewed upstream
driver packages:
