...
The Ubuntu job proves the isolated source/CLI build and dependency gates.
...
verifies the one shared 12-image release directory, stages the pinned Platform
Tools and Windows drivers under four small host directories, and compares their
source files and executables. It never copies images into an OS directory.
Physical R1 acceptance remains a separate gate.
